...
//Cuerpo de la issue de tipo Task con todos los campos necesarios y sus respectivos valores
def body = [
    "fields": [
        "project": [
...
//Creación del issue link "Relates To" de la issue de tipo Iniciativa con la issue de tipo Task
